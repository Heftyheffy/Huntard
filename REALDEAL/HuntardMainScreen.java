...
public class HuntardMainScreen extends JFrame{
	...
	*/
	...
	removeAllPanels();
        ...
        char1 = new JButton(chars.get(0).getFull());
        char2 = new JButton(chars.get(1).getFull());
        char3 = new JButton(chars.get(2).getFull());
	
	char1.setFocusPainted(false);
	char2.setFocusPainted(false);
	char3.setFocusPainted(false);
	
	char1.setBackground(new Color(130, 0, 0));
	char2.setBackground(new Color(130, 0, 0));
	char3.setBackground(new Color(130, 0, 0));        

        //Need to add buttons
	
        char1.addActionListener(new CharacterListener());
        char2.addActionListener(new CharacterListener());
        char3.addActionListener(new CharacterListener());
	...
	c.get(0).setHunger(40);
	c.get(0).setThirst(41);
	c.get(0).setmState(42);
