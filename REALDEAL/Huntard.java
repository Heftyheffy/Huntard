...
public class Huntard extends JFrame{
    JLabel title, gorilla, mainPanel;
    JButton start, load, options, exit;
    JPanel midPanel, lPanel, rPanel, titlePanel;    
    ImageIcon image;
    int count = 0;
    Color color1, color2;    
	...
	mainPanel = new JLabel(new ImageIcon("forest.jpg"));
	...
	lPanel.removeAll();
	JTextArea area = new JTextArea("Choose 3 Characters");
	area.setFont(new Font(Font.SERIF, Font.PLAIN, 20));
	...
	charSteve = new Character("Steve", 3, 1, 0, 2, new ImageIcon("steve.png"), new ImageIcon("sIcon.png"));
	charLarry = new Character("Larry", 1, 2, 3, 0, new ImageIcon("larry.png"), new ImageIcon("lIcon.png"));
	charJoanne = new Character("Joanne", 2, 0, 1, 3, new ImageIcon("joanne.png"), new ImageIcon("jnIcon.png"));
	charJoe = new Character("Joe", 0, 3, 2, 1, new ImageIcon("joe.png"), new ImageIcon("jIcon.png"));
	...
	sArea.setFont(new Font(Font.SERIF, Font.PLAIN, 20));
	lArea.setFont(new Font(Font.SERIF, Font.PLAIN, 20));
	jnArea.setFont(new Font(Font.SERIF, Font.PLAIN, 20));
	jArea.setFont(new Font(Font.SERIF, Font.PLAIN, 20));
	...
	mainPanel.add(lPanel, BorderLayout.NORTH);
    }
